...
#[derive(Debug)]
pub struct PhoenixLiveProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PhoenixLiveProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PhoenixLive processing");
    
    let mut processor = PhoenixLiveProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PhoenixLiveProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PhoenixLiveProcessor::new(false);
